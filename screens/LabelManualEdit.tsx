...
const LabelManualEdit: React.FC<Props> = ({ navigation }) => {
    ...
    const handleAddItem = async () => {
        ...
        try {
            ...
            if (user) {
                // Reference the 'expireItems' subcollection within the user's document
                const expireItemsCollectionRef = collection(db, 'users', user.uid, 'expireItems');

                await addDoc(expireItemsCollectionRef, {
                    itemName: productName, // Changed 'productName' to 'itemName' to match your subcollection structure
            ...
            console.error('Error adding document to expireItems: ', error);
